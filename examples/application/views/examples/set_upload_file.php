...
<hr/>
      <div class="row">
        ...
        <div class="col-lg-9">
          <p>For set upload image fields, use 'set_upload_file' parameter</p>
          <div class="well">
          <pre class="brush: js; first-line: 17">

            $config['set_upload_file'] = array('attachment' => array('media/files','doc|docx|pdf','2000'));
